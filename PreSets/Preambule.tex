...
\usepackage{tcolorbox} % Import tcolorbox package for creating colored boxes
...
\tcbset{
    abstract/.style={
        ...
        fontlower=\itshape,
        fontupper=\itshape,
        before lower=\textit{\textbf{Resumée}}\vspace*{0.25cm},
        before upper=\textit{\textbf{Abstract}}\vspace*{0.25cm}, % Space before the title
    }
}

% Define a style for the conclusions box
\tcbset{
    conclusions/.style={
        colback=blue!20!white, % Background color
        colframe=blue!20!black, % Frame color

...
\begingroup%
  ...
  \begin{picture}(1,0.78947368)%
    ...
    \put(0,0){\includegraphics[width=\unitlength]{chapter3/Figures/cow.pdf}}%
    ...
    \put(0.4,0.46){\begin{tabular}[t]{l}Ophthalmic\\Artery (OA)\end{tabular}}%
    ...
    \put(0.09,0.72){\begin{tabular}[t]{l} Anterior Communicating\\Artery (ACom)\end{tabular}}%
  \end{picture}%
\endgroup%
}
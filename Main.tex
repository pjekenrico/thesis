...
Modélisation et simulation hémodynamiques des déviateurs de flux pour le traitement des anévrismes intracrâniens}
...
\jurymember{6}{Aurélien LARCHER}{Chargé de recherche, Mines Paris}{Examinateur}
\jurymember{7}{Bruno Figliuzzi}{Chargé de recherche, Mines Paris}{Examinateur}
\jurymember{8}{Elie HACHEM}{Professor, Mines Paris}{Examinateur}

...
% Information in the cover page

% Thesis title
\title{Titre de la thèse/Thesis title}
...
\jurymember{7}{Aurélien LARCHER}{Mines Paris}{Co-encadrant de thèse}
...
\frkeywords{ Caesar licentia post honoratis haec adhibens urbium honoratis nullum Caesar.}
...
pdftitle={Title of the PDF},% title
...
\setcounter{page}{0}
\include{./introduction/introduction} % chapter1
\include{./chapter2/chapter2}
%\include{./chapter3/chapter3}
%\include{./chapter4/chapter4}
%\include{./chapter5/chapter5}
\include{./conclusion/conclusion} % last chapter

...
\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
	...
	% Text Node
	\draw (131.75,160.25) node [anchor=north west][inner sep=0.75pt] [align=left] {$R$};
	% Text Node
	\draw (88.5,81.25) node [anchor=north west][inner sep=0.75pt] [align=left] {$r$};
	% Text Node
	\draw (270,27.25) node [anchor=north west][inner sep=0.75pt] [align=left] {$\alpha$};
	% Text Node
	\draw (288.75,97.75) node [anchor=north west][inner sep=0.75pt] [align=left] {$L$};
	% Text Node
	\draw (237.75,155.75) node [anchor=north west][inner sep=0.75pt] [align=left] {$w$};
